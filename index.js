/**
 * @license
BodyPix es una biblioteca y modelo de aprendizaje automático desarrollado por Google que se utiliza para la segmentación 
en tiempo real del cuerpo humano en imágenes y videos. Utiliza técnicas de visión por computadora y aprendizaje profundo 
para identificar y separar las diferentes partes del cuerpo.
...
const state = {
  ...
  net: null,
  videoConstraints: {},
  // Activa el modelo TensorFlow para recargar
...
// En dispositivos móviles, el modo de orientación es la forma que se prefiera.
// Aquí usamos la etiqueta de la cámara para determinar si es el entorno 
// o la cámara que mira al usuario.
...
async function getConstraints(cameraLabel) {
  ...
  if (cameraLabel) {
    ...
    // En el móvil, usa el modo de orientación basado en la cámara.
...
/**
 * Carga la cámara que se usará en la demostración.
 *
 */
